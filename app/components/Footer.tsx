...
import { Recycle, Phone, Mail, MapPin, Clock } from "lucide-react";
...
const services = [
  ...
  { label: "Bulk Pickup", href: "/services" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <div>
                <div className="font-bold text-white text-base leading-tight">Right Ewaste</div>
                <div className="text-green-400 text-xs leading-tight">Recycle Pvt. Ltd.</div>
              </div>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed mb-5">
              Certified e-waste recycling solutions for a cleaner, greener tomorrow. Responsible, compliant, and secure.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919999999999" className="text-sm text-gray-400 hover:text-green-400 transition-colors">
                  +91 99999 99999
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-green-400 shrink-0" />
                <a href="tel:+918888888888" className="text-sm text-gray-400 hover:text-green-400 transition-colors">
                  +91 88888 88888
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-green-400 shrink-0" />
                <a href="mailto:info@rightewasterecycle.com" className="text-sm text-gray-400 hover:text-green-400 transition-colors">
