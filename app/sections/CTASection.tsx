    ...
    <section className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative overflow-hidden hero-gradient rounded-3xl px-6 py-12 sm:px-16 sm:py-16 text-center"
        >
          {/* Background circles */}
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center mb-10">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-400 text-white px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl font-semibold text-base shadow-lg shadow-green-500/30 hover:shadow-green-400/40 transition-all hover:-translate-y-0.5"
              >
                Contact Us <ArrowRight className="w-5 h-5" />
              </Link>
              <a
                href="tel:+919999999999"
                className="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl font-semibold text-base backdrop-blur-sm transition-all hover:-translate-y-0.5"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#25D366]/20 hover:bg-[#25D366]/30 border border-[#25D366]/40 text-white px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl font-semibold text-base transition-all hover:-translate-y-0.5"
              >
